...
<body style="background-color:;">
	...
	function delt()
	{
		...
		<input type="submit" value="delete admin" name="del" >
		</div>
		</form>
		<form action="" method="post" class="form-group">
		<div class="col-sm-12" style="margin-top:50px;">
		<input type="submit" value="show admin" class="btn-success"name="disp">
		...
		<?php if(isset($_POST["disp"]))
		{
			...
			$sql2="select * from login where usertype='admin'";
